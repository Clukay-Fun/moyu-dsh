window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var SidebarRoot_module_css_default = {
			...
			"newSession": "TQ0BVq_newSession",
			"newSessionLabel": "TQ0BVq_newSessionLabel",
		...
		*/
		function SidebarRoot({ collapsed, width, surface, startSession, toggleSidebar, setSurface, t, renderSlot }) {
