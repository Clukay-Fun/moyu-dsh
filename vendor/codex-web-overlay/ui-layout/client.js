window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:/Users/clukay/Program/deepseek-harness/packages/client/ui-layout/src/client/AppFrame.module.css.mjs
		const css = ".AgZ4Da_frame{background:var(--dsw-alias-bg-base);height:100%;transition:grid-template-columns var(--ds-transition-duration-slow) var(--ds-ease-in-out);grid-template-rows:100%;display:grid;position:relative;overflow:hidden}.AgZ4Da_frame[data-dragging]{transition:none}@media (prefers-reduced-motion:reduce){.AgZ4Da_frame{transition:none}}.AgZ4Da_sidebarCol{background:var(--dsw-specific-sidebar-fill);border-right:1px solid var(--dsw-alias-border-l1);min-width:0;overflow:hidden}.AgZ4Da_centerCol{flex-direction:column;min-width:0;display:flex;overflow:hidden}.AgZ4Da_detailsCol{border-left:1px solid var(--dsw-alias-border-l2);min-width:0;overflow:hidden}.AgZ4Da_frame[data-details-collapsed] .AgZ4Da_detailsCol{border-left:none}.AgZ4Da_handle{cursor:col-resize;z-index:2;touch-action:none;width:8px;transition:left var(--ds-transition-duration-slow) var(--ds-ease-in-out);margin-left:-4px;position:absolute;top:0;bottom:0}.AgZ4Da_frame[data-dragging] .AgZ4Da_handle{transition:none}@media (prefers-reduced-motion:reduce){.AgZ4Da_handle{transition:none}}.AgZ4Da_handle[data-side=details]:after{content:\"\";box-sizing:border-box;background:var(--dsw-alias-button-floating-fill);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);opacity:0;width:12px;height:32px;transition:opacity var(--ds-transition-duration-slow) var(--ds-ease-in-out), background var(--ds-transition-duration-slow) var(--ds-ease-in-out);border-radius:10px;position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.AgZ4Da_detailsCol:hover~.AgZ4Da_handle[data-side=details]:after,.AgZ4Da_handle[data-side=details]:hover:after,.AgZ4Da_handle[data-side=details][data-dragging=true]:after{opacity:1}.AgZ4Da_handle[data-side=details]:hover:after,.AgZ4Da_handle[data-side=details][data-dragging=true]:after{background:var(--dsw-alias-button-floating-hover);border-color:var(--dsw-alias-border-l3)}.AgZ4Da_overlayLayer{z-index:20;pointer-events:none;position:absolute;inset:0}.AgZ4Da_overlayLayer>*{pointer-events:auto}";
		...
		var AppFrame_module_css_default = {
			"centerCol": "AgZ4Da_centerCol",
			"detailsCol": "AgZ4Da_detailsCol",
			"frame": "AgZ4Da_frame",
			"handle": "AgZ4Da_handle",
			"overlayLayer": "AgZ4Da_overlayLayer",
			"sidebarCol": "AgZ4Da_sidebarCol"
		};
		//#endregion
		...
		*/
		...
		function AppFrame({ useStore, useSessions, actions, renderSlot }) {
			...
			const surface = panels.surface ?? "conversation";
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [(0, react_jsx_runtime.jsx)(CenterColumn, { children: surface === "conversation" ? renderSlot("conversation", {}) : renderSlot("surface", { surface }) }), (0, react_jsx_runtime.jsx)(DetailsColumn, { children: renderSlot("details", {}) })] }),
					(0, react_jsx_runtime.jsx)("div", {
		...
		*/
			...
			return (0, _deepseek_ai_dsh_client_runtime_client.defineStore)({
				...
				actions: {
					...
					setSurface: (d, surface) => {
						d.surface = surface;
						if (surface !== "conversation") d.details = 0;
					}
				}
			});
		}
		...
		var LayoutController = class {
			...
			*/
			...
			/** Show the conversation or one of the browser-only application surfaces. */
			setSurface(surface) {
				this.#require().setSurface(surface);
			}
			#require() {
