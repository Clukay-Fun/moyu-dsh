	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			"hero.headline": "Work faster, slack longer",
			"hero.preview": "",
		...
		*/
		...
		const css$7Glow = ".tpxdlq_headline{z-index:0;isolation:isolate;align-self:center;width:fit-content;max-width:100%;position:relative}.tpxdlq_glow{z-index:-1;aspect-ratio:1051/468;pointer-events:none;width:calc(100% + 136px);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}";
