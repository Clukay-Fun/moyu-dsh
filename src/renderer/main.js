...
function ensureBoardController() {
  ...
  boardController.mount({
    ...
    textStyle: document.querySelector('#board-text-style'),
    fontSize: document.querySelector('#board-font-size'),
    fontColor: document.querySelector('#board-font-color'),
    fontBold: document.querySelector('#board-font-bold'),
    textAlign: document.querySelector('#board-text-align'),
