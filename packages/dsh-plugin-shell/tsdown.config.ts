...
export default defineConfig([
  ...
  },
  {
    ...
    banner: { js: 'window.__ModuleLoader__.load({ id: "@moyu/dsh-plugin-shell", factory: (require) => { var module = { exports: {} }; var exports = module.exports;' },
