...
export default defineConfig([
  {
    ...
    dts: false, clean: true, external: [/^@deepseek-ai\//, 'pdf-lib', 'pdfjs-dist/legacy/build/pdf.mjs', 'sharp'],
    outputOptions: { entryFileNames: '[name].mjs' },
  },
  {
    entry: { client: 'src/client.tsx' }, outDir: 'lib', format: 'cjs', platform: 'browser',
    dts: false, clean: false, external: clientExternals, noExternal: [/.*/], plugins: [purityGate()],
    outputOptions: { entryFileNames: '[name].js' },
    banner: { js: 'window.__ModuleLoader__.load({ id: "@moyu/dsh-plugin-pdf", factory: (require) => { var module = { exports: {} }; var exports = module.exports;' },
